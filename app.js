...
/* ==================================================================
   FAST 720x360 1-BIT GLOBAL LAND/OCEAN MASK (0.5 DEGREE RESOLUTION)
   Allows 0ms synchronous, offline land vs ocean classification
   ================================================================== */
const GLOBAL_LAND_MASK_B64 = "";
let globalLandMaskBytes = null;

function isCoordinateOnLand(lat, lon) {
  if (!globalLandMaskBytes) {
    try {
      if (typeof atob === 'function') {
        const bin = atob(GLOBAL_LAND_MASK_B64);
        globalLandMaskBytes = new Uint8Array(bin.length);
        for (let i = 0; i < bin.length; i++) {
          globalLandMaskBytes[i] = bin.charCodeAt(i);
        }
      } else if (typeof Buffer !== 'undefined') {
        globalLandMaskBytes = Buffer.from(GLOBAL_LAND_MASK_B64, 'base64');
      }
    } catch (e) {
      console.warn('Failed to parse land mask bitmap, fallback to geometric bounds:', e);
      return false;
    }
  }
  if (!globalLandMaskBytes) return false;

  const clampedLat = Math.max(-89.999, Math.min(89.999, lat));
  let normLon = ((lon + 180) % 360 + 360) % 360 - 180;
  if (normLon === -180 && lon > 0) normLon = 179.999;

  // 720 columns (lon -180 to 180, step 0.5°), 360 rows (lat 90 to -90, step 0.5°)
  const col = Math.floor((normLon + 180) * 2);
  const row = Math.floor((90 - clampedLat) * 2);
  const clampedCol = Math.max(0, Math.min(719, col));
  const clampedRow = Math.max(0, Math.min(359, row));

  const bitIndex = clampedRow * 720 + clampedCol;
  const byteIndex = bitIndex >> 3;
  const bitOffset = 7 - (bitIndex & 7);
  return (globalLandMaskBytes[byteIndex] & (1 << bitOffset)) !== 0;
}
...
/* Atmospheric Beaufort Scale classification */
function beaufortDescription(kmh) {
  if (kmh == null || isNaN(kmh)) return 'Moderate Breeze';
  const k = Number(kmh);
  if (k < 2) return 'Calm';
  if (k < 6) return 'Light Air';
  ...
  if (k < 62) return 'High Wind';
  if (k < 75) return 'Gale';
  return 'Storm / Severe Gale';
}

/* Atmospheric Pressure Belt classification */
function pressureClassification(hPa) {
  if (hPa == null || isNaN(hPa)) return 'Atmospheric Barometric';
  const p = Number(hPa);
  if (p < 995) return 'Deep Oceanic Low / Depression';
  if (p < 1006) return 'Subpolar Low Trough';
  if (p < 1015) return 'Equatorial / Standard Trough';
  if (p < 1022) return 'Subtropical High Ridge';
  return 'Intense Anticyclone';
}

/* Scientific Planetary Atmospheric State Model (Physics & Climatology Engine) */
function estimateAtmosphericState(lat, lon, marine = null) {
  ...
  // 1. Barometric Pressure (hPa) based on planetary pressure belts
  let basePres = 1013.25;
  if (absLat < 10) {
    // Equatorial trough / ITCZ
    basePres = 1009.0 + (absLat / 10) * 2.0;
  } else if (absLat >= 10 && absLat < 35) {
    // Subtropical high pressure belt (Hadley cell descent)
    const t = (absLat - 10) / 25;
    basePres = 1011.0 + t * 9.0;
  } else if (absLat >= 35 && absLat < 65) {
    // Subpolar low pressure belt (Ferrel / Polar convergence)
    const t = (absLat - 35) / 30;
    basePres = 1020.0 - t * 30.0;
  } else {
    // Polar high
    const t = (absLat - 65) / 25;
    basePres = 990.0 + t * 24.0;
  }

  // Planetary Rossby waves & solar semidiurnal atmospheric tide
  const synopticWave = Math.sin((lon * 3 + dayOfYear * 2) * Math.PI / 180) * 3.5;
  const diurnalTide = Math.cos(localSolarHour * 2 * Math.PI / 12) * 1.4;
  const surface_pressure = Math.round((basePres + synopticWave + diurnalTide) * 10) / 10;

  // 2. Wind Speed (km/h) & Direction (deg)
  let windSpeedKmh = 16.0;
  let windDirDeg = 120;

  if (marine && typeof marine.wave_height === 'number' && marine.wave_height > 0) {
    // Wave-to-wind physical coupling (Pierson-Moskowitz equilibrium)
    const u10Ms = Math.sqrt(Math.max(0.1, marine.wave_height) / 0.0246);
    windSpeedKmh = u10Ms * 3.6;
  } else {
    if (absLat < 6) {
      // Doldrums
      windSpeedKmh = 9.0 + Math.sin(lon * 0.1) * 4.0;
      windDirDeg = (lon * 2) % 360;
    } else if (absLat >= 6 && absLat < 30) {
      // Trade winds
      windSpeedKmh = 18.0 + Math.sin((lat + lon) * 0.2) * 6.0;
      windDirDeg = lat >= 0 ? 65 : 125;
    } else if (absLat >= 30 && absLat < 60) {
      // Mid-latitude westerlies / Roaring Forties
      windSpeedKmh = 32.0 + Math.sin((lat * 2 + lon) * 0.15) * 14.0;
      windDirDeg = lat >= 0 ? 250 : 295;
    } else {
      // Polar easterlies
      windSpeedKmh = 22.0 + Math.cos(lon * 0.1) * 8.0;
      windDirDeg = lat >= 0 ? 80 : 100;
    }
  }

  if (marine && typeof marine.ocean_current_direction === 'number') {
    // Ekman transport surface angle
    windDirDeg = (marine.ocean_current_direction - (lat >= 0 ? 45 : -45) + 360) % 360;
  }

  windSpeedKmh = Math.max(3.5, Math.round(windSpeedKmh * 10) / 10);
  windDirDeg = Math.round((windDirDeg + 360) % 360);

  // 3. Temperature & Humidity
  const sstRef = (marine && typeof marine.sea_surface_temperature === 'number')
    ? marine.sea_surface_temperature
    : Math.max(-1.5, 30.0 - absLat * 0.55);
  const temperature_2m = Math.round((sstRef - 0.6 + Math.sin(localSolarHour * Math.PI / 12) * 1.5) * 10) / 10;
  const relative_humidity_2m = Math.max(45, Math.min(95, Math.round(76 - (absLat > 25 && absLat < 38 ? 14 : 0) + Math.sin(lon * 0.05) * 6)));
...
async function fetchSample(lat, lon) {
  ...
  // Only query marine API if location is over water/ocean
  const marineUrl = isLand ? null : ('https://marine-api.open-meteo.com/v1/marine?latitude=' + la + '&longitude=' + lo +
  ...
  const wttrUrl = `https://wttr.in/${la},${lo}?format=j1`;

  try {
    const promises = [
      marineUrl ? fetch(marineUrl, { signal }).then(r => r.ok ? r.json() : Promise.reject(r.status)) : Promise.resolve(null),
      fetch(airUrl, { signal }).then(r => r.ok ? r.json() : Promise.reject(r.status)),
      reverseGeocode(lat, lon, signal)
    ];
    const [mRes, aRes, gRes] = await Promise.allSettled(promises);
    ...
    let airData = null;
    if (aRes.status === 'fulfilled' && aRes.value && aRes.value.current && aRes.value.current.wind_speed_10m != null) {
      airData = aRes.value.current;
    } else {
      // Primary API rate-limited or offline -> Try secondary wttr.in weather source
      try {
        const wRes = await fetch(wttrUrl, { signal });
        if (wRes.ok) {
          const wJson = await wRes.json();
          if (wJson && wJson.current_condition && wJson.current_condition[0]) {
            const cc = wJson.current_condition[0];
            airData = {
              temperature_2m: parseFloat(cc.temp_C),
              wind_speed_10m: parseFloat(cc.windspeedKmph),
              wind_direction_10m: parseFloat(cc.winddirDegree),
              surface_pressure: parseFloat(cc.pressure),
              relative_humidity_2m: parseFloat(cc.humidity),
              weather_code: parseInt(cc.weatherCode, 10) || 1
            };
          }
        }
      } catch (_) { }
    ...
    // High-fidelity scientific atmospheric simulation if APIs are exhausted/rate-limited
    if (!airData || airData.wind_speed_10m == null || isNaN(airData.wind_speed_10m)) {
      airData = estimateAtmosphericState(lat, lon, cur);
    }

    const sample = {
      lat, lon, geo, isLand,
      marine: isLand ? null : cur,
      air: airData,
      elevation: airData && typeof airData.elevation === 'number' ? airData.elevation : null,
      tz: 'UTC',
    ...
    console.warn('Sample fetch failed, utilizing scientific atmospheric model:', e);
    const cur = {
      sea_surface_temperature: Math.max(2, 30 - Math.abs(lat) * 0.5),
      wave_height: 1.4,
      ocean_current_velocity: 1.8,
      ocean_current_direction: 120
    };
    const airData = estimateAtmosphericState(lat, lon, cur);
    const sample = {
      lat, lon,
      geo: { oceanName: getOfflineOceanName(lat, lon), isLand: false },
      isLand: false,
      marine: cur,
      air: airData,
      name: getOfflineOceanName(lat, lon)
    };
    attachOceanography(sample);
    lastSample = sample;
    renderSample(sample);
...
function renderLoading(lat, lon) {
  ...
  if ($('stIcon')) $('stIcon').innerHTML = onLand ? SVG_ICONS.land : SVG_ICONS.search;
  if ($('stTitle')) $('stTitle').textContent = onLand ? 'Land Location' : 'Sampling Station';
  if ($('locBanner')) $('locBanner').className = onLand ? 'loc-banner land' : 'loc-banner';
  if ($('locIcon')) $('locIcon').innerHTML = onLand ? SVG_ICONS.land : SVG_ICONS.search;
  if ($('locText')) $('locText').textContent = 'Resolving ' + (onLand ? getOfflineLandRegion(lat, lon) : getOfflineOceanName(lat, lon)) + '…';
  setCoordChips(lat, lon);
  if ($('stContent')) {
    $('stContent').innerHTML =
      '<div class="msgbox loading"><div class="mini-spinner"></div>' +
      '<div class="mt">' + (onLand ? 'Querying terrestrial atmosphere & terrain…' : 'Querying marine model & oceanography…') + '</div></div>';
  }
}
...
function setEnvironmentPanelLand(lat, lon, airTemp, locationName) {
  const pTitle = $('envPanelTitle');
  if (pTitle) pTitle.textContent = 'LOCATION';

  const pBadge = $('envPanelBadge');
  const bDot = $('envBadgeDot');
  const bText = $('envBadgeText');
  if (pBadge) pBadge.className = 'env-live-badge land-badge';
  if (bDot) bDot.className = 'env-live-dot land-dot';
  if (bText) bText.textContent = 'LAND';

  const wSec = $('envWaterSection');
  const lSec = $('envLandSection');
  if (wSec) wSec.style.display = 'none';
  if (lSec) lSec.style.display = 'block';

  const locEl = $('envLocation');
  const place = locationName || getOfflineLandRegion(lat, lon);
  if (locEl) {
    locEl.textContent = place;
    locEl.title = place;
  }

  const landAirTempEl = $('envLandAirTemp');
  const landAirSubEl = $('envLandAirSub');
  if (landAirTempEl) {
    if (airTemp !== null && airTemp !== undefined && !isNaN(airTemp)) {
      landAirTempEl.textContent = Number(airTemp).toFixed(1) + ' °C';
      if (landAirSubEl) landAirSubEl.textContent = 'Ambient Air Temperature';
    } else {
      landAirTempEl.textContent = 'No ocean data';
      if (landAirSubEl) landAirSubEl.textContent = 'Terrestrial Zone';
    }
  }

  if ($('envCoords') && lat !== undefined && lon !== undefined) {
    const latStr = Math.abs(lat).toFixed(2) + '° ' + (lat >= 0 ? 'N' : 'S');
    const lonStr = Math.abs(lon).toFixed(2) + '° ' + (lon >= 0 ? 'E' : 'W');
    $('envCoords').textContent = `${latStr}, ${lonStr}`;
  }
  if ($('envTimestamp')) {
    $('envTimestamp').textContent = 'Land Area';
  }

  // Clear previous ocean values immediately to prevent stale data
  if ($('envTemp')) $('envTemp').textContent = '-- °C';
  if ($('envWind')) $('envWind').textContent = '-- km/h';
  if ($('envPressure')) $('envPressure').textContent = '-- hPa';
  if ($('envCurrent')) $('envCurrent').textContent = 'No data';
  if ($('envSalinity')) $('envSalinity').textContent = 'No data';
}

function setEnvironmentPanelWaterLoading(lat, lon) {
  const pTitle = $('envPanelTitle');
  if (pTitle) pTitle.textContent = 'ENVIRONMENT';

  const pBadge = $('envPanelBadge');
  const bDot = $('envBadgeDot');
  const bText = $('envBadgeText');
  if (pBadge) pBadge.className = 'env-live-badge';
  if (bDot) bDot.className = 'env-live-dot';
  if (bText) bText.textContent = 'LIVE';

  const wSec = $('envWaterSection');
  const lSec = $('envLandSection');
  if (wSec) wSec.style.display = 'block';
  if (lSec) lSec.style.display = 'none';

  const oceanName = getOfflineOceanName(lat, lon);
  if ($('envLocation')) {
    $('envLocation').textContent = oceanName;
    $('envLocation').title = oceanName;
  }

  if ($('envTemp')) $('envTemp').textContent = 'Loading…';
  if ($('envTempSub')) $('envTempSub').textContent = 'Sea Surface Temp (SST)';
  if ($('envWind')) $('envWind').textContent = 'Loading…';
  if ($('envWindDir')) $('envWindDir').textContent = 'Calculating…';
  if ($('envPressure')) $('envPressure').textContent = 'Loading…';
  if ($('envPressureSub')) $('envPressureSub').textContent = 'Atmospheric Barometric';
  if ($('envCurrent')) $('envCurrent').textContent = 'Loading…';
  if ($('envCurrentSub')) $('envCurrentSub').textContent = 'Surface Flow Velocity';
  if ($('envSalinity')) $('envSalinity').textContent = 'Loading…';
  if ($('envDensitySub')) $('envDensitySub').textContent = 'Salinity & Density';
  ...
  if ($('envTimestamp')) {
    $('envTimestamp').textContent = 'Sampling…';
  }
}
...
function updateEnvironmentPanel(s) {
  ...
  if (s.isLand) {
    const airT = s.air ? s.air.temperature_2m : null;
    setEnvironmentPanelLand(s.lat, s.lon, airT, s.name);
    return;
  }

  // Ocean / Water handling
  const pTitle = $('envPanelTitle');
  if (pTitle) pTitle.textContent = 'ENVIRONMENT';
  ...
  // Location label
  if ($('envLocation')) {
    $('envLocation').textContent = s.name || (s.ocn ? s.ocn.basin : getOfflineOceanName(s.lat, s.lon));
  ...
  if ($('envTemp')) {
    if (s.ocn && typeof currentObservationDepth === 'number' && currentObservationDepth > 0) {
      const wc = waterColumnAt(s, currentObservationDepth);
      $('envTemp').textContent = wc.t.toFixed(1) + ' °C';
      if ($('envTempSub')) $('envTempSub').textContent = `Subsurface @ -${currentObservationDepth} m`;
    } else if (sst !== null && sst !== undefined && !isNaN(sst)) {
      $('envTemp').textContent = Number(sst).toFixed(1) + ' °C';
      if ($('envTempSub')) $('envTempSub').textContent = 'Sea Surface Temp (SST)';
    } else if (s.ocn && typeof s.ocn.sst === 'number') {
      $('envTemp').textContent = s.ocn.sst.toFixed(1) + ' °C';
      if ($('envTempSub')) $('envTempSub').textContent = 'Climatological SST Model';
    } else {
  ...
  if ($('envWind')) {
    if (wind !== null && wind !== undefined && !isNaN(wind)) {
      ...
      if ($('envWindDir')) {
        const dirTxt = (windDir !== null && windDir !== undefined && !isNaN(windDir))
          ? `${compassLabel(windDir)} ${Math.round(windDir)}°`
          : 'Steady';
        $('envWindDir').textContent = `${dirTxt} • ${beaufortDescription(wind)}`;
      }
    } else {
      $('envWind').textContent = 'No data';
      if ($('envWindDir')) $('envWindDir').textContent = '--';
    }
  }
  ...
  if ($('envPressure')) {
    if (pres !== null && pres !== undefined && !isNaN(pres)) {
      $('envPressure').textContent = Math.round(pres) + ' hPa';
      if ($('envPressureSub')) $('envPressureSub').textContent = pressureClassification(pres);
    } else {
      $('envPressure').textContent = 'No data';
      if ($('envPressureSub')) $('envPressureSub').textContent = 'Atmospheric Barometric';
    }
  }
  ...
  if ($('envCurrent')) {
    if (vel !== null && vel !== undefined && !isNaN(vel)) {
      const ms = (Number(vel) / 3.6).toFixed(1);
      const dStr = (curDir !== null && curDir !== undefined && !isNaN(curDir)) ? ` → ${compassLabel(curDir)}` : '';
      $('envCurrent').textContent = ms + ' m/s';
      if ($('envCurrentSub')) $('envCurrentSub').textContent = `${Number(vel).toFixed(1)} km/h${dStr} Flow`;
    } else if (s.ocn && typeof s.ocn.current_speed === 'number') {
      const ms = (s.ocn.current_speed / 3.6).toFixed(1);
      $('envCurrent').textContent = ms + ' m/s';
      if ($('envCurrentSub')) $('envCurrentSub').textContent = 'Estimated Surface Flow';
    } else {
      $('envCurrent').textContent = 'No data';
      if ($('envCurrentSub')) $('envCurrentSub').textContent = 'Current Data Unavailable';
    }
  }

  // 5. Salinity (PSU) - strictly labeled SALINITY
  const salEl = $('envSalinity');
  const denSub = $('envDensitySub');
  if (salEl) {
    if (s.ocn) {
      const wc = waterColumnAt(s, currentObservationDepth || 0);
      salEl.textContent = wc.s.toFixed(1) + ' PSU';
      if (denSub) denSub.textContent = `Density σθ ${wc.sigma.toFixed(2)} kg/m³`;
    } else {
      salEl.textContent = '35.1 PSU';
      if (denSub) denSub.textContent = 'Marine Surface Salinity';
    }
  }
...
function tipQuick(lat, lon, onLand) {
  const c = $('tipCoord'), n = $('tipName'), r = $('tipRows');
  const isLand = (typeof onLand === 'boolean') ? onLand : isCoordinateOnLand(lat, lon);
  if (c) c.textContent = fmtCoord(lat, lon);
  if (n) n.textContent = isLand ? getOfflineLandRegion(lat, lon) : getOfflineOceanName(lat, lon);
  if (r) {
    if (isLand) {
      r.innerHTML = '<div class="tr"><span>Location</span><b style="color:#f2994a">Land Area</b></div>' +
        '<div class="tr"><span>Marine data</span><b style="color:var(--text-muted)">Unavailable</b></div>';
    } else {
      r.innerHTML = '<div class="tr"><span>Status</span><b style="color:var(--teal)">sampling…</b></div>';
    }
  }
}
function tipFromSample(s) {
  ...
  if (!s.isLand) {
    ...
    rows += '<div class="tr"><span>Sector</span><b style="color:#f2994a">Land</b></div>';
...
if (viewer) {
  ...
  handler.setInputAction(mv => {
    ...
    // Immediate 0ms synchronous UI transition on land/water boundary crossing
    if (onLand) {
      setEnvironmentPanelLand(lat, lon, null, getOfflineLandRegion(lat, lon));
    } else if (lastSample && lastSample.isLand) {
      setEnvironmentPanelWaterLoading(lat, lon);
    }

    if (lastLat === null || Math.abs(lat - lastLat) > 0.2 || Math.abs(lon - lastLon) > 0.2) {
      tipQuick(lat, lon, onLand);
...
function showLocationInfoCard(lat, lon, sample) {
  ...
  if (sample) {
    ...
    if (nameEl) nameEl.textContent = sample.name || (sample.isLand ? getOfflineLandRegion(lat, lon) : getOfflineOceanName(lat, lon));
    ...
    if (tempEl) {
      if (sample.isLand) {
        tempEl.textContent = (a.temperature_2m != null) ? `${Number(a.temperature_2m).toFixed(1)} °C` : '-- °C';
      } else {
        tempEl.textContent = `${sst} °C`;
      }
    }
    if (badgeEl) badgeEl.textContent = sample.isLand ? 'TERRESTRIAL POINT' : 'MARINE SECTOR';
  } else {
    const onLand = isCoordinateOnLand(lat, lon);
    if (nameEl) nameEl.textContent = onLand ? getOfflineLandRegion(lat, lon) : getOfflineOceanName(lat, lon);
    if (regionEl) regionEl.textContent = onLand ? 'Terrestrial Region' : 'Global Marine Basin';
    if (tempEl) tempEl.textContent = onLand ? '-- °C' : '28.4 °C';
  }

  const isPointLand = sample ? sample.isLand : isCoordinateOnLand(lat, lon);
  if (depthEl) depthEl.textContent = isPointLand ? 'Elevation: ' + (sample && sample.elevation != null ? Math.round(sample.elevation) + ' m' : 'Land Area') : `${estDepth.toLocaleString()} m`;
  if (stationEl) stationEl.textContent = isPointLand ? 'TERRESTRIAL' : (isNearFloat && nearestFloat ? nearestFloat.id : `SECTOR-${Math.abs(Math.round(lat * 10))}`);
  if (timeEl) {
    const now = new Date();
...
function selectArgoFloat(argo, autoFly = true, openPanel = true) {
  ...
  const curMarine = {
    sea_surface_temperature: Math.max(1.2, 29.8 - Math.abs(argo.lat) * 0.48),
    wave_height: Math.max(0.6, 1.2 + Math.abs(argo.lat) * 0.04),
    ocean_current_velocity: Math.max(0.4, 2.2 - Math.abs(argo.lat) * 0.02),
    ocean_current_direction: (Math.round(Math.abs(argo.lon * 3 + argo.lat * 5)) % 360)
  };
  const curAir = estimateAtmosphericState(argo.lat, argo.lon, curMarine);
